...
function twoj_slideshow_field( $field, $meta ) {
	wp_enqueue_script( 'twoj_slideshow_gallery', 	twoj_slideshow_URL . 'js/gallery.lib.min.js', 	array( 'jquery' ), null );
	wp_enqueue_script( 'twoj_slideshow_init', 		twoj_slideshow_URL . 'js/script.min.js', 			array( 'jquery', 'twoj_slideshow_gallery' ), null );
